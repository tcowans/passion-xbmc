...
echo '
  ...
  <tr class="windowbg2">
  	...
  	<td align="right"><b>', $txt['downloads_custom_previewPictureURL'], '</b>&nbsp;</td>


  	<td><input type="text" name="previewPictureURL" size="50" />
...
<tr class="windowbg"><td><b>Has the Downloads Systen helped you?</b> Then support the developers:<br />
...

{
	...
	global $context, $ID_MEMBER,  $modSettings, $scripturl, $txt, $db_passwd;
