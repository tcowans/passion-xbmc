...
item_title = {TYPE_SCRAPER: TITLE_SCRAPER, TYPE_SKIN: TITLE_SKIN, TYPE_SCRIPT: TITLE_SCRIPT, TYPE_PLUGIN: TITLE_PLUGIN, TYPE_PLUGIN_MUSIC: TITLE_PLUGIN_MUSIC, TYPE_PLUGIN_PICTURES: TITLE_PLUGIN_PICTURES, TYPE_PLUGIN_PROGRAMS: TITLE_PLUGIN_PROGRAMS, TYPE_PLUGIN_VIDEO: TITLE_PLUGIN_VIDEO }
item_index = {TYPE_SCRAPER: INDEX_SCRAPER, TYPE_SKIN: INDEX_SKIN, TYPE_SCRIPT: INDEX_SCRIPT, TYPE_PLUGIN: INDEX_PLUGIN, TYPE_PLUGIN_MUSIC: INDEX_PLUGIN_MUSIC, TYPE_PLUGIN_PICTURES: INDEX_PLUGIN_PICTURES, TYPE_PLUGIN_PROGRAMS: INDEX_PLUGIN_PROGRAMS, TYPE_PLUGIN_VIDEO: INDEX_PLUGIN_VIDEO }
