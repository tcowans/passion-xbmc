...
class Viewer:
    ...
    def getText( self ):
        try:
            if sys.argv[ 1 ] == "infolabels":
                return "InfoLabels", self.readFile( "docs/README.txt" )

            elif sys.argv[ 1 ] == "howtostart":
                return "How To Run", self.readFile( "docs/HowToRun.txt" )
...
class WebBrowser:
    ...
    def __init__( self, *args, **kwargs ):
        try:
            url = kwargs.get( "url" ) or sys.argv[ 2 ]
            # notify user
