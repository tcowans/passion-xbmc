...
# constants
scraper_name = "TelevisionTunes.com"
base_url     = "http://www.televisiontunes.com/"
...
#print re.findall( "<strong>Your User Agent:</strong> (.*?)<br />", urllib.urlopen( "http://whatsmyuseragent.com/" ).read() )
