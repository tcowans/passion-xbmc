...
class TTT( xbmcgui.WindowXMLDialog ):
    ...
    def onInit( self ):
        try:
            ...
            self.list_item.setProperty( "toplay", _( 32100 ) )
        except:
            print_exc()
            raise
    ...
    def resetContainer( self ):
        ...
        self.list_item.setProperty( "toplay", _( 32102 ) )
        self.tilesID = {
            ...
            if not self.xbmc_art._is_playing:
                if controlID in ( 11, 12, 13, 21, 22, 23, 31, 32, 33 ):
                    ...
                    if self.player_vs_who == "XBMC":
                        ...
                        self.list_item.setProperty( "toplay", _( 32101 ) )
    ...
    def have_winner( self ):
        try:
            ...
            if linewin:
                ...
                if "X" == who:
                    self.list_item.setProperty( "toplay", _( 32105 ) )
                    self.score_player_one += 1
                    self.list_item.setProperty( "score_player_one", str( self.score_player_one ) )
                    self.list_item.setProperty( "fanart_win", "fanart_win.png" )
                    self.fanart_win = True
                elif "O" == who:
                    self.list_item.setProperty( "toplay", ( _( 32106 ), _( 32107 ) )[ ( self.player_vs_who == "XBMC" ) ] )
                ...
                self.list_item.setProperty( "toplay", _( 32108 ) )
                xbmc.sleep( 1000 )
                self.setFocusId( 320 )
                #self.tiles.print_tiles()
        except:
