...
en visitant leur site web www.tetesaclaques.tv et/ou en achetant le DVD(s)
...
14-11-08 Version 1.0 par Temhil:
  ...
  - Creation d'un menu 'options' permettant le choix du lecteur, l'effacement auto du cache et le choix de la 
    langue au demarrage
...
21-10-08 Version Beta2 par Temhil: 
  ...
  - Ajout support Anglais/Francais (langue et navigation des videos)
  ...
  - Ajout téléchargement des photos en arriere plan 
   (l'utilisateur n'est plus bloqué au démarrage durant le téléchargement 
    des photos)
  - Suppression des fonctions de tri (vote/date): plus supportées pour le moment du aux changements du site Web 
...
27-04-08 Version Beta1 par Temhil
  ...
  - Attention les images son telerchargees dans le repertoire cache mais
    ...
    c'est le le script sera plus rapide à charger! ;-)
