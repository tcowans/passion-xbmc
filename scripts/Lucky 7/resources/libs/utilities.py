...
FILE_LUCKY_7_V1   = xbmc.translatePath( "special://xbmc/scripts/Lucky 7/resources/Lucky7v1/default_v1.py" )
FILE_KEYMAP_INFOS = xbmc.translatePath( "special://xbmc/scripts/Lucky 7/resources/KeymapInfos.xml" )

CREDITS_FILE      = xbmc.translatePath( "special://masterprofile/script_data/Lucky 7/credits.db" )
#CREDITS_FILE      = xbmc.translatePath( "special://profile/script_data/Lucky 7/credits.db" )
SCREENSHOT_DATA   = xbmc.translatePath( "special://masterprofile/script_data/Lucky 7/ScreenShot/" )
#SCREENSHOT_DATA   = xbmc.translatePath( "special://profile/script_data/Lucky 7/ScreenShot/" )
...
def wiki_default_controls( controller=0 ):
    extender_remote = "http://xbmc.org/wiki/images/6/6d/Extender_remote_schematics_1_global.jpg"
    xbox_dvd_remote = "http://xbmc.org/wiki/images/4/42/Xbox-dvd-remote-global.jpg"
    xbox_controller = "http://xbmc.org/wiki/images/1/12/Global_Controller.png"
