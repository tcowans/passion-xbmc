...
__svn_url__      = "http://code.google.com/p/passion-xbmc/source/browse/#svn/trunk/scripts/HangMan/"
...
class __flag__(xbmcgui.WindowDialog):
    def __init__(self):
        ...
        self.addControl(xbmcgui.ControlLabel(120,108,420,32,label[97],'special13','0xDDced8da'))
...
class Scores_infos(xbmcgui.WindowDialog):
    def __init__(self):
        ...
        self.addControl(xbmcgui.ControlLabel(120,108,420,32,label[100],'special13','0xDDced8da'))
        self.label1 = str(glob.item).split(", ")
        self.label2 = self.label1[0].split(". ")
        self.addControl(xbmcgui.ControlLabel(130,150,420,32,label[101]+" "+str(glob.pos+1),"font13"))
        self.addControl(xbmcgui.ControlLabel(130,180,420,32,label[102]+" "+self.label2[1],"font13"))
        self.addControl(xbmcgui.ControlLabel(130,210,420,32,label[103]+" "+str(glob.item2),"font13"))
        self.addControl(xbmcgui.ControlLabel(130,240,420,32,self.label1[1],"font13"))
        self.addControl(xbmcgui.ControlLabel(130,270,420,32,label[104]+" "+self.label1[3],"font13"))
        self.addControl(xbmcgui.ControlLabel(130,300,420,32,label[105]+" "+self.label1[2],"font13"))
...
class __HangMan__(xbmcgui.WindowDialog):
    def __init__(self):
        ...
        self.Heading = xbmcgui.ControlLabel(120,108,420,32,__script__,'special13','0xDDced8da')
        self.addControl(self.Heading)

        self.hidden_letter = xbmcgui.ControlLabel(0,325,720,18,"","font13",alignment=0x00000002)
        ...
        self.Line_mess = xbmcgui.ControlLabel(0,503,720,18,label[5],"special12",'0xDDced8da',alignment=0x00000002)
        self.addControl(self.Line_mess)

        self.Line_hi_score = xbmcgui.ControlLabel(600,108,420,32,label[7]+" "+str(self.level["hi_score"]),'special12',"0xffD2FF00",alignment=0x00000001)
        ...
        self.btn_A = xbmcgui.ControlButton(
            165,400,30,30,"A",font="special13",
            focusTexture=BG5,
            noFocusTexture=BG6,
        ...
        self.btn_B = xbmcgui.ControlButton(
            195,400,30,30,"B",font="special13",
            focusTexture=BG5,
            noFocusTexture=BG6,
            alignment=self.align)
        ...
        self.btn_C = xbmcgui.ControlButton(
            225,400,30,30,"C",font="special13",
            focusTexture=BG5,
            noFocusTexture=BG6,
            alignment=self.align)
        ...
        self.btn_D = xbmcgui.ControlButton(
            255,400,30,30,"D",font="special13",
            focusTexture=BG5,
            noFocusTexture=BG6,
            alignment=self.align)
        ...
        self.btn_E = xbmcgui.ControlButton(
            285,400,30,30,"E",font="special13",
            focusTexture=BG5,
            noFocusTexture=BG6,
            alignment=self.align)
        ...
        self.btn_F = xbmcgui.ControlButton(
            315,400,30,30,"F",font="special13",
            focusTexture=BG5,
            noFocusTexture=BG6,
            alignment=self.align)
        ...
        self.btn_G = xbmcgui.ControlButton(
            345,400,30,30,"G",font="special13",
            focusTexture=BG5,
            noFocusTexture=BG6,
            alignment=self.align)
        ...
        self.btn_H = xbmcgui.ControlButton(
            375,400,30,30,"H",font="special13",
            focusTexture=BG5,
            noFocusTexture=BG6,
            alignment=self.align)
        ...
        self.btn_I = xbmcgui.ControlButton(
            405,400,30,30,"I",font="special13",
            focusTexture=BG5,
            noFocusTexture=BG6,
            alignment=self.align)
        ...
        self.btn_J = xbmcgui.ControlButton(
            435,400,30,30,"J",font="special13",
            focusTexture=BG5,
            noFocusTexture=BG6,
            alignment=self.align)
        ...
        self.btn_K = xbmcgui.ControlButton(
            465,400,30,30,"K",font="special13",
            focusTexture=BG5,
            noFocusTexture=BG6,
            alignment=self.align)
        ...
        self.btn_L = xbmcgui.ControlButton(
            495,400,30,30,"L",font="special13",
            focusTexture=BG5,
            noFocusTexture=BG6,
            alignment=self.align)
        ...
        self.btn_M = xbmcgui.ControlButton(
            525,400,30,30,"M",font="special13",
            focusTexture=BG5,
            noFocusTexture=BG6,
            alignment=self.align)
        ...
        self.btn_N = xbmcgui.ControlButton(
            165,430,30,30,"N",font="special13",
            focusTexture=BG17,
            noFocusTexture=BG18,
            alignment=self.align)
        ...
        self.btn_O = xbmcgui.ControlButton(
            195,430,30,30,"O",font="special13",
            focusTexture=BG5,
            noFocusTexture=BG6,
            alignment=self.align)
        ...
        self.btn_P = xbmcgui.ControlButton(
            225,430,30,30,"P",font="special13",
            focusTexture=BG5,
            noFocusTexture=BG6,
            alignment=self.align)
        ...
        self.btn_Q = xbmcgui.ControlButton(
            255,430,30,30,"Q",font="special13",
            focusTexture=BG5,
            noFocusTexture=BG6,
            alignment=self.align)
        ...
        self.btn_R = xbmcgui.ControlButton(
            285,430,30,30,"R",font="special13",
            focusTexture=BG5,
            noFocusTexture=BG6,
            alignment=self.align)
        ...
        self.btn_S = xbmcgui.ControlButton(
            315,430,30,30,"S",font="special13",
            focusTexture=BG5,
            noFocusTexture=BG6,
            alignment=self.align)
        ...
        self.btn_T = xbmcgui.ControlButton(
            345,430,30,30,"T",font="special13",
            focusTexture=BG5,
            noFocusTexture=BG6,
            alignment=self.align)
        ...
        self.btn_U = xbmcgui.ControlButton(
            375,430,30,30,"U",font="special13",
            focusTexture=BG5,
            noFocusTexture=BG6,
            alignment=self.align)
        ...
        self.btn_V = xbmcgui.ControlButton(
            405,430,30,30,"V",font="special13",
            focusTexture=BG5,
            noFocusTexture=BG6,
            alignment=self.align)
        ...
        self.btn_W = xbmcgui.ControlButton(
            435,430,30,30,"W",font="special13",
            focusTexture=BG5,
            noFocusTexture=BG6,
            alignment=self.align)
        ...
        self.btn_X = xbmcgui.ControlButton(
            465,430,30,30,"X",font="special13",
            focusTexture=BG5,
            noFocusTexture=BG6,
            alignment=self.align)
        ...
        self.btn_Y = xbmcgui.ControlButton(
            495,430,30,30,"Y",font="special13",
            focusTexture=BG5,
            noFocusTexture=BG6,
            alignment=self.align)
        ...
        self.btn_Z = xbmcgui.ControlButton(
            525,430,30,30,"Z",font="special13",
            focusTexture=BG15,
            noFocusTexture=BG16,
            alignment=self.align)
        ...
        self.btn_indice = xbmcgui.ControlButton(
            255,370,210,30,label[62],font="special13",
            focusTexture=BG19,
            noFocusTexture=BG20,
            alignment=self.align)
        ...
        self.btn_new = xbmcgui.ControlButton(
            165,370,90,30,label[64],font="special13",
            focusTexture=BG13,
            noFocusTexture=BG14,
            alignment=self.align)
        ...
        self.btn_solution = xbmcgui.ControlButton(
            465,370,90,30,label[63],font="special13",
            focusTexture=BG11,
            noFocusTexture=BG12,
            alignment=self.align)
        ...
        self.btn_hi_scores = xbmcgui.ControlButton(
            120,145,110,32,label[6],font="special13",
            focusTexture=BG3,
            noFocusTexture=BG4,
            alignment=self.align)
        ...
        self.btn_sounds = xbmcgui.ControlButton(
            120,180,110,32,label[65],font="special13",
            focusTexture=BG3,
            noFocusTexture=BG4,
            alignment=self.align)
        ...
        self.btn_flag = xbmcgui.ControlButton(
            120,215,110,32,label[96],font="special13",
            focusTexture=BG3,
            noFocusTexture=BG4,
            alignment=self.align)
        ...
        self.btn_hard = xbmcgui.ControlButton(
            120,250,110,32,self.label_hard,font="special13",
            focusTexture=BG3,
            noFocusTexture=BG4,
            alignment=self.align)
        ...
        self.btn_dic = xbmcgui.ControlButton(
            120,285,110,32,label[92],font="special13",
            focusTexture=BG3,
            noFocusTexture=BG4,
            alignment=self.align)
        ...
        self.btn_quit = xbmcgui.ControlButton(
            120,320,110,32,label[67],font="special13",
            focusTexture=BG3,
            noFocusTexture=BG4,
            alignment=self.align)
